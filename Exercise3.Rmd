...
- Use [`ENMeval`](https://github.com/jamiemkass/ENMeval) to build and evaluate Maxent SDMs
...
In this exercise, we will work through the new [`ENMeval` vignette](https://jamiemkass.github.io/ENMeval/articles/ENMeval-2.0.0-vignette.html). Before beginning, you should download the development version of the package:

```{r, eval=FALSE}
devtools::install_packages("jamiemkass/ENMeval")
```
