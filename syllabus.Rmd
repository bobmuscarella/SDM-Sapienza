...
- [Lecture 3: Model Evaluation](): Guest lecture by [Jamie Kass](https://scholar.google.com/citations?user=LM_UNdkAAAAJ&hl=en)
- [Lecture 4: SDM algorithms]()

**Afternoon session** (*Practical*)

- [Exercise 3: Model evaluation of algorithms]()
- [Exercise 4: Overview of algorithms](Exercise3.html)
...
- [Exercise 5: Evaluation and projection](Exercise4.html)
