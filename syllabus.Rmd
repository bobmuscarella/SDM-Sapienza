...
- [Lecture 3: Model Evaluation](lectures/2. Kass_mod_eval_sapienzaU_2021.pdf): Guest lecture by [Jamie Kass](https://scholar.google.com/citations?user=LM_UNdkAAAAJ&hl=en)
<!-- - Lecture 4: SDM algorithms -->

**Afternoon session** (*Practical*)

- [Exercise 3: Model evaluation](Exercise3.html)
- [Exercise 4: Overview of algorithms](Exercise4.html)
...
<!-- - Exercise 5: Evaluation and projection -->
