...
- Presence-absence algorithms
  - GLM (base R `stats` packae): D. Zurell has [this nice example of fitting a simple SDM using GLMs](https://damariszurell.github.io/HU-GCIB/3_SDM_intro.html), and here is [another exampe in R](https://rspatial.org/raster/sdm/5_sdm_models.html) from R Spatial.
